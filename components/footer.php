     ...
     <div class="container grid grid-cols-1 ">
         <div class="col-span-1 space-y-4">
             <div class="flex justify-start items-start w-full">
                 <span class="text-black text-2xl font-bold">HOMEANG <span class="text-yellow-600">FURNISHING</span></span>
 ...
 <div class="bg-gray-800 py-4">
     <div class="container flex items-center justify-between">
         <p class="text-white">&copy; HOMEANG FURNISHING - All Right Reserved</p>
         <div>
             <!-- <img src="../assets/homeng.jpg" alt="methods" class="h-5"> -->
         </div>
     </div>
 </div>
 <!-- ./copyright -->