...
<head>
    ...
    <title>HOMEANG FURNISHING</title>
...
<body>
    ...
    <div class="container py-16">
        <div class="w-10/12 grid grid-cols-1 md:grid-cols-3 gap-6 mx-auto justify-center">
            <div class="border border-orange-600 rounded-sm px-3 py-6 flex justify-center items-center gap-5">
    ...
    <div class="container pb-16">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div class="bg-white shadow rounded overflow-hidden group">
                ...
                <a href="#" class="block w-full py-1 text-center text-white bg-orange-600 border border-orange-600 rounded-b hover:bg-transparent hover:text-orange-600 transition">Add
                    to cart</a>
                <a href="#" class="block w-full py-1 text-center text-white bg-blue-600 border border-blue-600 rounded-b hover:bg-transparent hover:text-blue-600 transition">Add
                    Request Costum</a>
            </div>
            <div class="bg-white shadow rounded overflow-hidden group">
                <div class="relative">
